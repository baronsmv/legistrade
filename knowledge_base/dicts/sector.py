sector = {
    ...
    "Moda y Textiles": {
        ...
        "Obligaciones Legales": (
            ...
            "Cumplimiento de leyes sobre " "condiciones laborales en " "manufactura",
        ),
    },
    "Pesca": {
        "Características": (
    ...
    "Telecomunicaciones": {
        ...
        "Obligaciones Fiscales": (
            ...
            "Declaración de ingresos por " "comercialización de " "servicios móviles",
        ),
        "Obligaciones Legales": (
...
sector = {k: ({"Sector principal": k} | v) for k, v in sorted(sector.items())}
